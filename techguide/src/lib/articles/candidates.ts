...
export const futureArticleCandidates = [
  ...
  {
    title: 'TechGuideが、いきなり大きな開発を勧めない理由',
    category: 'techguide-approach',
  ...
  {
    title: '相談から実装まで、TechGuideがどう伴走するか',
  ...
  {
    title: '小さな会社のIT相談で、TechGuideが大切にしていること',
    category: 'techguide-approach',
  ...
  {
    title: '見積もりの前に、TechGuideが確認したいこと',
    category: 'business-technology-alignment',
  ...
  {
    title: 'AI活用を相談するとき、TechGuideが最初に見ること',
