...
export const story: StoryContent = {
  ...
  valuesTitle: 'Values',
  valuesIntro: '会社全体で、仕事や関係づくりの判断基準にする5つ。',
  values: [
    {
      title: '相手を知ることから始める。',
      description: '要望だけでなく、その背景にある想い、状況、大切にしていることを理解する。',
    },
    {
      title: '本当に役立つことを選ぶ。',
      description:
        '自分が提供したいものより、相手に必要なものを優先する。作らないことや、別の人に頼むことも選択肢にする。',
    },
    {
      title: '誠実さで、安心を積み重ねる。',
      description:
        '約束を大切にし、できること・できないこと、不確かなことを率直に伝える。困ったときほど対話を欠かさない。',
    },
    {
      title: '一人で抱えず、力を持ち寄る。',
      description:
        '自分の得意を活かし、苦手なことは頼る。知識や経験を共有し、互いにできることを増やしていく。',
    },
    {
      title: '無理なく続く関係を育てる。',
      description:
        '顧客、仲間、自分や家族の生活を犠牲にしない。一度きりの成果だけでなく、信頼や経験が残る仕事を選ぶ。',
    },
  ],
};
